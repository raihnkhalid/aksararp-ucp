...
<head>
    ...
    <title>A:RP - Home</title>
    @vite('resources/css/app.css')
</head>
<body class="bg-gray-900">
    <nav class="py-2 border-gray-200 rounded bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-wrap items-center justify-between mx-5">
            <button data-collapse-toggle="sidebar" type="button" class="inline-flex items-center text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-hamburger" aria-expanded="false">
                <span class="sr-only">Open main menu</span>
                <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
            </button>
            <a href="#" class="flex items-center">
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">{{ Auth::user()->username }}</span>
                <img src="{{ url('/storage/images/main_logo.png') }}" class="h-12 w-12" alt="Flowbite Logo" />
            </a>
...
<aside class="w-64 hidden" id="sidebar" aria-label="Sidebar">
